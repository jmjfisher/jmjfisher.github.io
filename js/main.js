    ...
    if ($(window).innerWidth() > 1.9*$(window).innerHeight()) {
        ...
        if (id == "chile-thumb"){
            ...
            $("#caption-4")
                ...
                .slideDown(250);
        } else if (id == "btb-thumb"){
            $("#caption-1")
                .hide()
                .html("<p class='caption'>Data-lite golf yardage web-app measuring user's HTML Geolocation API location against PostGIS points with a <i>Caddyshack</i> theme.</p>")
                .slideDown(250);
        } else {
            clearCaption
        };
